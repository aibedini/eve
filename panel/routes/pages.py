...
def settings_page():
    ...
    return render_template('settings.html',
                         ...
                         sms_provider=sms_cfg.get('provider', 'gmweb'),
                         sms_gmweb_base_url=(sms_cfg.get('providers') or {}).get('gmweb', {}).get('base_url', ''),
                         sms_gmweb_api_key=(sms_cfg.get('providers') or {}).get('gmweb', {}).get('api_key', ''),
                         sms_gmweb_timeout=(sms_cfg.get('providers') or {}).get('gmweb', {}).get('timeout_seconds', 15),
                         sms_custom_base_url=(sms_cfg.get('providers') or {}).get('custom_http', {}).get('base_url', ''),
                         sms_custom_api_key=(sms_cfg.get('providers') or {}).get('custom_http', {}).get('api_key', ''),
                         sms_custom_timeout=(sms_cfg.get('providers') or {}).get('custom_http', {}).get('timeout_seconds', 15),
                         ...
                         sms_hourly_limit=sms_cfg.get('hourly_limit', 0),
