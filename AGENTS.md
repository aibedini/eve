...
- `panel/services/` — business logic: `ownership.py`, `billing.py`, `subscription.py`, `backup.py` (DB/Telegram backup; `TELEGRAM_BACKUP_TMP_DIR` bound via `init_backup_tmp_dir(app)` from `app.py`).
