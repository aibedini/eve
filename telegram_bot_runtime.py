...
COPY = {
    "fa": {
        ...
        "tutorial_app_unavailable": "این برنامه غیرفعال یا حذف شده است. دوباره نوع دستگاه را انتخاب کنید.",
        "tutorial_recommended": "⭐ پیشنهادی",
        "tutorial_download": "⬇️ دانلود مستقیم",
        "tutorial_google_play": "▶️ گوگل‌پلی",
        "tutorial_app_store": " اپ‌استور",
        "tutorial_store": "🛍 فروشگاه",
        "tutorial_video": "🎬 فیلم آموزش",
        "tutorial_back_devices": "⬅️ انتخاب دستگاه",
        ...
        "depletion_renew_button": "🚀 تمدید سریع: {package}",
        ...
        "trial_channel_required": "برای دریافت سرویس تست، ابتدا باید عضو کانال‌های تلگرام زیر شوید و سپس دوباره امتحان کنید:\n{channels}",
        "trial_channel_recheck": "✅ عضو شدم، بررسی مجدد",
        ...
        "service_rotate": "🔄 ابطال لینک و دریافت لینک جدید",
        "service_rotate_confirm": "⚠️ با ابطال لینک، لینک و کانفیگ‌های فعلی بلافاصله از کار می‌افتند و یک لینک جدید با همان اعتبار باقی‌مانده صادر می‌شود.\nاعتبار فعلی: {days} روز · {gb} گیگابایت\n\nمطمئن هستید؟",
        "service_rotate_yes": "✅ بله، ابطال کن",
        "service_rotate_no": "❌ انصراف",
        "service_rotate_done": "✅ لینک قبلی ابطال شد و لینک جدید با همان اعتبار صادر شد.\nاعتبار باقی‌مانده: {days} روز · {gb} گیگابایت\n{link}",
        "service_rotate_failed": "⚠️ ابطال لینک ناموفق بود: {error}",
        "service_rotate_limited": "به حد مجاز روزانه‌ی ابطال لینک رسیدید؛ فردا دوباره تلاش کنید.",
    ...
    "en": {
        ...
        "tutorial_app_unavailable": "This app was disabled or removed. Choose your device again.",
        "tutorial_recommended": "⭐ Recommended",
        "tutorial_download": "⬇️ Direct download",
        "tutorial_google_play": "▶️ Google Play",
        "tutorial_app_store": " App Store",
        "tutorial_store": "🛍 Store",
        "tutorial_video": "🎬 Video tutorial",
        "tutorial_back_devices": "⬅️ Choose device",
        ...
        "depletion_renew_button": "🚀 Quick renew: {package}",
        ...
        "trial_channel_required": "To claim the free trial, join these Telegram channels first, then try again:\n{channels}",
        "trial_channel_recheck": "✅ I joined, check again",
        ...
        "service_rotate": "🔄 Revoke link & get a new one",
        "service_rotate_confirm": "⚠️ Revoking the link immediately disables your current link and configs, and a new link is issued with the same remaining credit.\nCurrent credit: {days} day(s) · {gb} GB\n\nAre you sure?",
        "service_rotate_yes": "✅ Yes, revoke it",
        "service_rotate_no": "❌ Cancel",
        "service_rotate_done": "✅ The old link was revoked and a new link with the same credit was issued.\nRemaining credit: {days} day(s) · {gb} GB\n{link}",
        "service_rotate_failed": "⚠️ Could not rotate the link: {error}",
        "service_rotate_limited": "You have reached the daily link-rotate limit; try again tomorrow.",
