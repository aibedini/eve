...
REPO_URL="${EVE_REPO_URL:-https://github.com/aibedini/eve.git}"
...
print_git_fetch_help() {
    ...
    echo "  - SSH deploy key: EVE_REPO_URL=git@github.com:aibedini/eve.git bash setup.sh"
...
show_banner() {
    ...
    echo -e "${NC}"
    echo -e "  ${DIM}  github.com/aibedini/eve   by aibedini${NC}"
    echo -e "  ${DIM}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
